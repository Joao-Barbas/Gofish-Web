...
{
    /// <inheritdoc />
    public partial class Pata : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupUser_GroupRole_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "seed-player-1", 0, "seed-cstamp-1", "player1@gofish.com", true, null, null, false, null, "PLAYER1@GOFISH.COM", "PLAYER1", "AQAAAAIAAYagAAAAEG0+dcHtCO+GsOAfBm7ZJcjphja3Acn4HbiHhOkrEeJNJywK8CXb5cer0yhanVktLg==", null, false, "seed-stamp-1", false, 0, "player1" },
                    { "seed-player-2", 0, "seed-cstamp-2", "player2@gofish.com", true, null, null, false, null, "PLAYER2@GOFISH.COM", "PLAYER2", "AQAAAAIAAYagAAAAEBkjbMaqSYoWra6dlj4xxfZ6gcrvjQnufpjqGOaH5qpYu82MKXOz7MiG7i0KLePD/g==", null, false, "seed-stamp-2", false, 0, "player2" },
                    { "seed-player-3", 0, "seed-cstamp-3", "player3@gofish.com", true, null, null, false, null, "PLAYER3@GOFISH.COM", "PLAYER3", "AQAAAAIAAYagAAAAEDskoKNGA1mJtCRTK/APILOmMeRAcA6HMdVJUECnloKWWQ7hMaQp4/WsfIG04SeKXg==", null, false, "seed-stamp-3", false, 0, "player3" },
                    { "seed-player-4", 0, "seed-cstamp-4", "player4@gofish.com", true, null, null, false, null, "PLAYER4@GOFISH.COM", "PLAYER4", "AQAAAAIAAYagAAAAEOywhUznEEiE0FdS/she8J5DtK9y8V2FQKVjahCFOR0LtzrRtmQ5bNiu9qNY/PaPHw==", null, false, "seed-stamp-4", false, 0, "player4" },
                    { "seed-player-5", 0, "seed-cstamp-5", "player5@gofish.com", true, null, null, false, null, "PLAYER5@GOFISH.COM", "PLAYER5", "AQAAAAIAAYagAAAAEBkI6obqEEVDUMkpIrPHHS6o9+Vtks+6/Uz4oCUt/e2sy6ozmRPS4dPT2sz8sUw81g==", null, false, "seed-stamp-5", false, 0, "player5" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), null, 0, 38.515000000000001, -8.8709999999999987, 1, "seed-player-2", 0 },
                    ...
                    { 6, 1, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), null, 0, 38.518000000000001, -8.8679999999999986, 1, "seed-player-1", 0 },
                    { 7, 1, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), null, 0, 38.524999999999999, -8.8669999999999991, 1, "seed-player-2", 0 },
                    { 8, 1, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), null, 0, 38.519999999999996, -8.859, 1, "seed-player-3", 0 },
                    { 9, 1, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), null, 0, 38.521000000000001, -8.8330000000000002, 1, "seed-player-4", 0 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 102, 0, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), 1, 38.518000000000001, -8.875, 1, "seed-player-2", 0 },
                    ...
                    { 104, 0, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), 1, 38.521999999999998, -8.8879999999999999, 1, "seed-player-4", 0 },
                    ...
                    { 106, 0, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), 1, 38.527999999999999, -8.8979999999999997, 1, "seed-player-1", 0 },
                    ...
                    { 109, 0, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), 1, 38.552999999999997, -8.8889999999999993, 1, "seed-player-4", 0 },
                    { 110, 0, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), 1, 38.548999999999999, -8.9089999999999989, 1, "seed-player-5", 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 202, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), 2, 38.509999999999998, -8.8689999999999998, "seed-player-2", 0, 1 },
                    ...
                    { 205, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), 2, 38.500999999999998, -8.8689999999999998, "seed-player-5", 0, 1 },
                    ...
                    { 207, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), 2, 38.500999999999998, -8.8549999999999986, "seed-player-2", 0, 1 },
                    { 208, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), 2, 38.491999999999997, -8.8379999999999992, "seed-player-3", 0, 1 },
                    { 209, new DateTime(2026, 3, 1, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2026, 3, 11, 12, 0, 0, 0, DateTimeKind.Utc), 2, 38.472999999999999, -8.8409999999999993, "seed-player-4", 0, 1 },
