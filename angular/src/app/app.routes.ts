...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [ // unfinished
      ...
      { path: 'reports/reported-pin', loadComponent: () => import('@gofish/features/statistics/children/reported-pin-page/reported-pin-page.component').then(d => d.ReportedPinPageComponent) },
